...
<%--		<div class="row">--%>
<%--			<div class="col-lg-12">--%>
<%--				&lt;%&ndash; ${pageNumber}/${currentPage}/${maxPages} and ${pageNumber - 5} and ${pageNumber + 5} &ndash;%&gt;--%>
...
<%--									&lt;%&ndash; pageNumber + 5: ${pageNumber + 5} &ndash;%&gt;--%>
...
<%--								</c:when>--%>
<%--								<c:otherwise>--%>
<%--									&lt;%&ndash;  ${pageNumber - 2} - ${pageNumber + 2} &ndash;%&gt;--%>
